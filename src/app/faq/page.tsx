            ...
            <div className="mx-auto max-w-3xl space-y-4">
              {faqs.map((item, index) => (
                <Reveal key={item.question} delay={index * 100}>
                  <details
                    className="group relative overflow-hidden rounded-2xl border border-border/60 bg-[linear-gradient(135deg,rgba(15,23,42,0.8),rgba(5,7,14,0.9))]/80 p-5 text-left text-sm text-muted backdrop-blur-md transition-all duration-300 ease-out hover:border-primary/30 hover:bg-[linear-gradient(135deg,rgba(15,23,42,0.85),rgba(5,7,14,0.95))]/90 hover:shadow-lg hover:shadow-primary/5 sm:p-6"
                  >
                    <div
                    ...
                    <summary className="relative flex cursor-pointer list-none items-center justify-between gap-4 text-sm font-medium text-foreground">
                    ...
                    <div className="relative mt-4 border-t border-border/40 pt-4 text-sm leading-relaxed text-muted/90">
